...
if (!$printingCenters) {
    die("Error fetching printing centers: " . $conn->error);
}

// Store printing centers in an array
$printingCentersArray = [];
while ($center = $printingCenters->fetch_assoc()) {
    $printingCentersArray[] = $center;
}
...
<body>
    ...
    <form method="POST" class="form-container">
        <select name="center_id" required>
            ...
            <?php foreach ($printingCentersArray as $center): ?>
